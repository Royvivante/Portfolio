...
function ProjectCard({ project, index }: { project: Project; index: number }) {
  return (
    <motion.article
      ...
      className={cn(
        "group relative rounded-2xl border border-card-border bg-card p-6 sm:p-8 transition-all duration-300",
        "hover:border-card-border-hover hover:shadow-[0_0_40px_rgba(99,102,241,0.06)]",
